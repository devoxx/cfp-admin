...
}).factory('UsersService', function($q, $filter) {
    var currentUser = {
        id: '123321',
...
angular.module('Services').factory('Tags', function($resource, $q, $filter) {
    var cached;
...
angular.module('Services').factory('Events', function($resource) {
